...
See [Vector Logging Setup](./08-vector-logging.md) for details.
...
- **Plan upgrades**: See [Upgrades & Maintenance](./06-upgrades-maintenance.md)
- **Monitor health**: See [Status & Troubleshooting](./07-status-troubleshooting.md)
