---
metaDescription: Configure release environments in Rulebricks to define deployment targets, approval workflows, and promotion hierarchies for your rules and flows.
---
