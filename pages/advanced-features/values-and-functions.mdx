...
![Dynamic Values](/static/images/advanced-features/values-1.png)
...
![Values Tab](/static/images/advanced-features/dynamic-values-tab.png)

### Create a new value

Scroll down to the "Dynamic Values" section, and click "Create New Value". Fill in a name, select a data type, and enter a value.

![New Value](/static/images/advanced-features/creating-values.png)
...
![Use Value](/static/images/advanced-features/values-1.png)
...
![Functions](/static/images/advanced-features/values-2.png)
