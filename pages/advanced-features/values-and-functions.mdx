---
metaDescription: Dynamic values and functions in Rulebricks allow you to store and reference values and custom code in your rules. Learn how to set them up here.
---
...
If you have a lot of values to create at once, you can use the [Dynamic Values API](https://rulebricks.com/docs/api-reference#tag/dynamic-values) to bulk import them. This is especially useful if you're migrating from another system, or if you just have a lot of business terminology to reference in your rules.

import { Callout } from 'nextra/components'

<Callout type="info">
Bulk import is currently only available through the API. If you need help with this, feel free to reach out to us over discord (link in the top bar) or at [support@rulebricks.com](mailto:support@rulebricks.com).Soon you'll also be able to bulk import & update values from a spreadsheet or CSV file directly in the Rulebricks dashboard.
</Callout>
