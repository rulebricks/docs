---
metaDescription: Condition priorities allow you to specify arbitrary subgroup "flights" of conditions that should be evaluated before others. Learn how to set them up here.
---
