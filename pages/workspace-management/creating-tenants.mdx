...
User Groups partition your workspace into isolated sections. Users only see rules and flows in their assigned groups, which is useful for multi-team organizations, client isolation, or separating environments.
