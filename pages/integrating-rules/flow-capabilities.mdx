...
Extract structured data from text using the AI connection configured in your workspace settings (Settings → AI features, OpenAI or Anthropic). Useful for:
...
3. Optionally pick a model from your provider (defaults to your workspace's fast model)
4. Click "Run Inference"

This node (and other AI features) only appears once an AI connection is configured for your workspace.
