...
The Rulebricks Flow editor is **reactive**—as you make changes to rule input fields, the editor automatically updates results in real-time. This makes it easy to see how your flow behaves as you build it.

Reactivity applies to all sequences of nodes until a code execution node is reached. Code nodes pause execution until you manually click the run button, preventing accidental spam to external services.
