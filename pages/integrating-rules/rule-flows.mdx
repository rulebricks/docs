...
![Rule Flows](/static/images/integrating-rules/flow-reactivity.gif)
...
![Flows Tab](/static/images/integrating-rules/flows-tab.png)
...
![Create Flow](/static/images/integrating-rules/create-flow.png)
...
![Rule Flow Editor](/static/images/integrating-rules/flow-start.png)
...
![Rule Flow Editor](/static/images/integrating-rules/flow-edit.png)
