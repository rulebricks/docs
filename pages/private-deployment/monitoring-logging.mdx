---
metaDescription: Configure monitoring and centralized logging for your Rulebricks deployment. Learn about Prometheus, Grafana, and Vector logging setup.
---
...
These sinks require cloud provider IAM setup. See [Vector Logging Setup](./vector-logging) for IAM configuration.
...
- **Set up cloud storage logging**: See [Vector Logging Setup](./vector-logging)
