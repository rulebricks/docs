---
metaDescription: Learn how to upgrade your Rulebricks deployment and manage versions. This guide covers zero-downtime upgrades, rollback procedures, and maintenance tasks.
---
...
<Callout>
  Automated backup functionality is planned but not yet implemented. The backup
  configuration exists in the schema but is not currently used during
  deployment.
</Callout>
...
- **Monitor your deployment**: See [Status & Troubleshooting](./status-troubleshooting)
