...
<Callout type="info">
  Grafana is the pane of glass for **metrics**. For **traces** and **logs** (request lineage), see [Distributed Tracing](/private-deployment/tracing), which forwards to your chosen backend (Elastic APM, a generic OTLP backend, or Azure Monitor).
</Callout>
