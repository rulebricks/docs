---
metaDescription: Get started with the Rulebricks CLI. Learn how to install the CLI, configure your first deployment, and deploy your Rulebricks cluster.
---
...
Our CLI offers a particularly high level of DevOps automation, and allows you to spin up dedicated, automatically scaling Rulebricks clusters in as few as two CLI commands.
However, we strongly recommend still paging through as many of these docs as you can, as it's important you understand what these commands are running under the hood.
...
<Callout>
  The CLI will check for required dependencies and provide installation
...
2. **In configuration file** (see [Initial Setup](./initial-setup)):
...
- **Customize Configuration**: See [Configuration Reference](./configuration-reference)
- **Upgrade Your Deployment**: See [Upgrades & Maintenance](./upgrades-maintenance)
...
For more troubleshooting help, see [Status & Troubleshooting](./status-troubleshooting).
