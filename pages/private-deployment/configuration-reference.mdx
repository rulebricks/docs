...
The Supabase services can run in-cluster while pointing at an external PostgreSQL server (e.g. a managed instance). Set `supabase.externalDatabase.enabled: true` and configure the connection once:
