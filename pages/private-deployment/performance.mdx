...
If you deploy with the [Rulebricks CLI](/private-deployment/cli#performance-tiers), a performance tier (Small, Medium, or Large) sets all of these values consistently for you. Tune by hand only when you need to go beyond a tier.
