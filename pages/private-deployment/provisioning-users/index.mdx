---
metaDescription: Understand controls to automatically configure Rulebricks app access, roles, and tenancy for users entering Rulebricks via an external Identity Provider.
---
