...
| Tier       | Intended Use          | Throughput\*               | Cluster Resources   |
| :--------- | :-------------------- | :------------------------- | :------------------ |
| **Small**  | Development & Testing | Up to ~5,000 rules/sec     | 8 vCPU, 16GB RAM    |
| **Medium** | Production            | ~5,000 to 25,000 rules/sec | 16+ vCPU, 32GB+ RAM |
| **Large**  | High Performance      | 25,000+ rules/sec          | 40+ vCPU, 80GB+ RAM |
...
For the sizing model behind these numbers (and how to tune beyond a tier), see [Performance & Scaling](/private-deployment/performance).
...
See [Monitoring](/private-deployment/monitoring) for what's scraped, the metric label policy, ClickStack, tracing, app logs, and remote write configuration.
