...
<Callout type="info">
Logs are retained for 15 days on most plans and appear in the dashboard within seconds of execution.
</Callout>
...
Decision Data Query Language lets you search by the actual data in your requests and responses—not just metadata.
