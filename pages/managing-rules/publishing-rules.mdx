...
This lets you build deployment workflows around your rules—test against a specific version while developing the next one.

<Callout>
The clock icon next to each version lets you **roll back**. This is destructive—versions between your current state and the rollback target are permanently lost as API targets.
</Callout>
...
<Callout type="info">
New versions take effect roughly 1 minute after publishing while caches update.
</Callout>
