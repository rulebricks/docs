---
metaDescription: Install the Rulebricks Embedded package, generate scoped embed tokens on your server, and render the embedded rule editor in your React app.
---
