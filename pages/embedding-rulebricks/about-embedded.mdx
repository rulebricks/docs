---
metaDescription: Rulebricks Embedded lets engineering teams ship enterprise-grade, user-configurable rule editing inside their own product, without building a rule engine from scratch.
---

# Why Rulebricks Embedded?

![Embedded Visual](https://d1zic6dm9txw4h.cloudfront.net/rulebricks-docs-assets/static/images/embedding.png)
